/* 
* Custom version of HL Crowbar for Instagib mode - Snk.EmA
*/
...
class weapon_icrowbar : ScriptBasePlayerWeaponEntity
{
	...
	{
		self.Precache();
		g_EntityFuncs.SetModel( self, self.GetW_Model( "models/hl/w_crowbar.mdl") );
		self.m_iClip			= -1;
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/snk_ema/im/v_crowbar.mdl" );
		g_Game.PrecacheModel( "models/hl/w_crowbar.mdl" );
		g_Game.PrecacheModel( "models/hl/p_crowbar.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/snk_ema/im/v_crowbar.mdl" ), self.GetP_Model( "models/hl/p_crowbar.mdl" ), CROWBAR_DRAW, "crowbar" );
	}
	...
	void Holster( int skiplocal /* = 0 */ )
	{
		...
		self.SendWeaponAnim( CROWBAR_HOLSTER );
	}
...
string GetICrowbarName()
{
	return "weapon_icrowbar";
}

void RegisterICrowbar()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_icrowbar", GetICrowbarName() );
	g_ItemRegistry.RegisterWeapon( GetICrowbarName(), "misc_weapons" );
}
