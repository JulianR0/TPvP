...
class weapon_hlegon : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/hl/w_egon.mdl" );
	...
	void Precache()
	{
		g_Game.PrecacheModel( "models/hl/w_egon.mdl" );
		g_Game.PrecacheModel( "models/hl/v_egon.mdl" );
		g_Game.PrecacheModel( "models/hl/p_egon.mdl" );
	...
	bool Deploy()
	{
		...
		return self.DefaultDeploy( self.GetV_Model( "models/hl/v_egon.mdl" ), self.GetP_Model( "models/hl/p_egon.mdl" ), EGON_DRAW, "egon" );
	}
