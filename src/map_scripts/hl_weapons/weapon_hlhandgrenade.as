...
class HLSDK_CGrenade : ScriptBaseMonsterEntity
{
	...
	void Spawn()
	{
		...
		g_EntityFuncs.SetModel( self, "models/hl/w_grenade.mdl" );
	...
	void Precache()
	{
		g_Game.PrecacheModel( "models/hl/w_grenade.mdl" );
...
HLSDK_CGrenade@ ShootTimed( entvars_t@ pevOwner, Vector& in vecStart, Vector& in vecVelocity, float time )
{
	...
	pGrenade.pev.model = string_t( "models/hl/w_grenade.mdl" );
...
class weapon_hlhandgrenade : ScriptBasePlayerWeaponEntity
{
	...
	{
		g_Game.PrecacheModel( "models/hl/w_grenade.mdl" );
		g_Game.PrecacheModel( "models/hl/v_grenade.mdl" );
		g_Game.PrecacheModel( "models/hl/p_grenade.mdl" );
	...
	{
		m_flReleaseThrow = -1;
		return self.DefaultDeploy( self.GetV_Model( "models/hl/v_grenade.mdl" ), self.GetP_Model( "models/hl/p_grenade.mdl" ), HANDGRENADE_DRAW, "crowbar" );
	}
