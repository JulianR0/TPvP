...
class weapon_hlcrowbar : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/hl/v_crowbar.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/hl/v_crowbar.mdl" ), self.GetP_Model( "models/hl/p_crowbar.mdl" ), CROWBAR_DRAW, "crowbar" );
	}
