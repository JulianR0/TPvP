...
class weapon_hl9mmhandgun : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/hl/w_9mmhandgun.mdl" );
	...
	void Precache()
	{
		g_Game.PrecacheModel( "models/hl/v_9mmhandgun.mdl" );
		g_Game.PrecacheModel( "models/hl/w_9mmhandgun.mdl" );
		g_Game.PrecacheModel( "models/hl/p_9mmhandgun.mdl" );
		...
		g_SoundSystem.PrecacheSound( "weapons/hl/pl_gun1.wav" ); // silenced handgun
		g_SoundSystem.PrecacheSound( "weapons/hl/pl_gun2.wav" ); // silenced handgun
		g_SoundSystem.PrecacheSound( "weapons/hl/pl_gun3.wav" ); // handgun
		
		g_Game.PrecacheGeneric( "sound/weapons/hl/pl_gun1.wav" );
		g_Game.PrecacheGeneric( "sound/weapons/hl/pl_gun2.wav" );
		g_Game.PrecacheGeneric( "sound/weapons/hl/pl_gun3.wav" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/hl/v_9mmhandgun.mdl" ), self.GetP_Model( "models/hl/p_9mmhandgun.mdl" ), GLOCK_DRAW, "onehanded" );
	}
	...
	void GlockFire( float& in flSpread, float& in flCycleTime )
	{
		...
		if ( self.pev.body == 1 )
		{
			...
			switch( Math.RandomLong( 0, 1 ) )
			{
				case 0:
				{
					g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "weapons/hl/pl_gun1.wav", Math.RandomFloat( 0.9, 1.0 ), ATTN_NORM );
					break;
				}
				case 1:
				{
					g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "weapons/hl/pl_gun2.wav", Math.RandomFloat( 0.9, 1.0 ), ATTN_NORM );
					break;
				}
			}
		}
		else
		{
			...
			g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "weapons/hl/pl_gun3.wav", Math.RandomFloat( 0.92, 1.0 ), ATTN_NORM, 0, 98 + Math.RandomLong( 0, 3 ) );
		}
