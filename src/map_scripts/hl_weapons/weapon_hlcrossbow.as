...
class CCrossbowBolt : ScriptBaseEntity
{
	...
	void BoltTouch( CBaseEntity@ pOther )
	{
		...
		if ( pOther.pev.takedamage > 0 )
		{
			...
			if ( pOther.IsPlayer() )
			{
				pOther.TraceAttack( pevOwner.pev, 20, pev.velocity.Normalize(), tr, DMG_NEVERGIB );
			}
			else
			{
...
class weapon_hlcrossbow : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/hl/w_crossbow.mdl" );
	...
	void Precache()
	{
		g_Game.PrecacheModel( "models/hl/v_crossbow.mdl" );
		g_Game.PrecacheModel( "models/hl/w_crossbow.mdl" );
		g_Game.PrecacheModel( "models/hl/p_crossbow.mdl" );
	...
	{
		if ( self.m_iClip > 0 )
			return self.DefaultDeploy( self.GetV_Model( "models/hl/v_crossbow.mdl" ), self.GetP_Model( "models/hl/p_crossbow.mdl" ), CROSSBOW_DRAW1, "bow" );
		return self.DefaultDeploy( self.GetV_Model( "models/hl/v_crossbow.mdl" ), self.GetP_Model( "models/hl/p_crossbow.mdl" ), CROSSBOW_DRAW2, "bow" );
	}
