...
class CSatchelCharge : ScriptBaseEntity
{
	void Spawn()
	{
		...
		g_EntityFuncs.SetModel( self, "models/hl/w_satchel.mdl" );
...
class weapon_hlsatchel : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/hl/w_satchel.mdl" );
	...
	bool Deploy()
	{
		...
		if ( self.pev.iuser1 > 0 )
			return self.DefaultDeploy( self.GetV_Model( "models/hl/v_satchel_radio.mdl" ), self.GetP_Model( "models/hl/p_satchel_radio.mdl" ), SATCHEL_RADIO_DRAW, "hive" );
		else
			return self.DefaultDeploy( self.GetV_Model( "models/hl/v_satchel.mdl" ), self.GetP_Model( "models/hl/p_satchel.mdl" ), SATCHEL_DRAW, "trip" );
	}
