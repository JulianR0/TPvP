...
const int STICK_DEFAULT_GIVE	= 2;
const int STICK_MAX_CARRY		= 5;
const int STICK_WEIGHT			= 1;
...
class weapon_stick : ScriptBasePlayerWeaponEntity
{
	...
	{
		m_pPlayer.m_flNextAttack = WeaponTimeBase() + 0.75;
	...
	void WeaponIdle()
	{
		...
		if ( m_flStartThrow > 0.0 )
		{
			...
			@pGrenade = g_EntityFuncs.ShootTimed( m_pPlayer.pev, vecSrc, vecThrow, 3.0 );
